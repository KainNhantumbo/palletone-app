...
export function TriadicTab() {
  const { harmonyColors, setHarmonyColors, rawTriadicColors, triadicColorActions } =
    useHarmonyColors();
        ...
        <section className="flex w-full flex-col gap-3">
          <section className="flex flex-col gap-2">
            ...
            <div className="mx-auto flex w-full max-w-lg flex-col gap-2">
              ...
              <p className="text-sm ">
                Three colors that are evenly spaced on the color wheel. This combination
                creates bold and vibrant color palettes.
              </p>
            </div>
          </section>
        </section>
