...
export function TetradicTab() {
  const { harmonyColors, setHarmonyColors, tetradicColorActions, rawTetradicColors } =
    useHarmonyColors();
    ...
    <section className="flex w-full flex-col">
      <section className="base-border flex w-full flex-col gap-3 rounded-2xl bg-foreground-default p-4 lg:flex-row ">
        <div className="base-shadow base-border grid max-h-[680px]  w-full grid-cols-5 overflow-clip rounded-2xl lg:max-w-[350px]">
          {[...harmonyColors.tetradic.values, harmonyColors.tetradic.originalColor].map(
            (value, i) => (
              <Fragment key={i}>
                <div
                  style={{
        ...
        <section className="flex w-full flex-col gap-3">
          <section className="flex flex-col gap-2">
            ...
            <div className="mx-auto flex w-full max-w-lg flex-col gap-2">
              ...
              <p className="text-sm ">
                Four colors that are evenly spaced on the color wheel. For this combination,
                works best if you let one color be dominant and others as accents.
              </p>
            </div>
          </section>
        </section>
